...
export const getssoToken = 'api/auth/jwt/ssoToken' //获取eeeetoken     post
...
export const dailyChangeVersionList = (pageSize, currentPageNum) => `api/dc2/bbgl/DailyChangeVersion/list/${pageSize}/${currentPageNum}`
//系统管理-流程定义
