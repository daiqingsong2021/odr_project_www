...
class DrivingTable extends Component {
    ...
    componentDidMount(){
        getBaseData('fr_url').then(data => { this.setState({ src: `http://${data[0].value}/webroot/decision/view/form?viewlet=%25E6%2595%2585%25E9%259A%259C%25E6%2597%25A5%25E5%2586%25B5%25E6%259F%25A5%25E8%25AF%25A2.frm` }) })
