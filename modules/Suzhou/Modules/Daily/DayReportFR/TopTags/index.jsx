...
import { addFineDailyReport , generateCCDailyWorkReportFile, deleteFineReport } from '@/modules/Suzhou/api/suzhou-api';
...
export class TopTags extends Component {
    ...
    btnClicks = (name, type) => {
        ...
        if (name == 'DeleteTopBtn') {
            ...
            if (deleteArray.length > 0) {
                axios.deleted(deleteFineReport, { data: deleteArray }, true).then(res => {
    ...
    submit = (values, type) => {
        ...
        if(type == 'save'){
            //帆软日报
            axios.post(addFineDailyReport, params, true).then(res => {
            ...
            <div className={style.main}>
                ...
                {this.state.isShowRelease &&
                    <Release
                        ...
                        proc={{ "bizTypeCode": "processing-fine-report-approve", "title": "运营日报审批流程" }}
