...
export class TopTags extends Component {
    ...
    submit = (values, type) => {
        ...
        if(type == 'save'){
            //运营日报
            axios.post(generateDailyWorkReportFile, params, true).then(res => {
        ...
        return (
            <div className={style.main}>
                ...
                <div className={style.tabMenu}>
                    {permission && permission.indexOf('LIST_ADD') !== -1 && (
                ...
                {this.state.isShowRelease &&
                    <Release
                        ...
                        proc={{ "bizTypeCode": "processing-report-approve", "title": "运营日报审批流程" }}
