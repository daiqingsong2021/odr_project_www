...
import { addDailyRepresentation,updateDailyRepresentation,deleteDailyRepresentation } from '@/modules/Suzhou/api/suzhou-api';
    ...
    btnClicks = (name, type) => {
        ...
        if (name == 'DeleteTopBtn') {
            if (selectedRowKeys.length > 0) {
                axios.deleted(deleteDailyRepresentation, { data: selectedRowKeys }, true).then(res => {
        ...
        return (
            <div className={style.main}>
                ...
                <div className={style.tabMenu}>
                    {(permission && permission.indexOf('OTHERINFO_ADD')!=-1) && (
                    ...
                    {/* {(permission && permission.indexOf('CONSTRUCTIONMANAGE_CONSTRUCTION-APPROVE')!=-1) && (
                        ...
                        <PublicButton name={'发布'} title={'发布'} icon={'icon-fabu'}
                            ...
                            res={'MENU_EDIT'} />)} */}
                    {(permission && permission.indexOf('OTHERINFO_DELETE')!=-1) && (
