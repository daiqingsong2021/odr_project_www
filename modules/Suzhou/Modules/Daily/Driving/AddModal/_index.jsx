        ...
        treeDataZq.map(item => {
            if (item.id == value) {
                ...
                this.setState({
                    ...
                    startDriveTime: item.startDriveTime,   //首班时间
                    endDriveTime: item.endDriveTime,    //末班时间
                    passengerMiles: item.passengerMiles, //当日计划载客里程
                    emptyMiles: item.emptyMiles,    //当日计划空驶里程
                    allLinePassenageMiles: item.allLinePassenageMiles,//当日计划既有线载客里程
                    allLineEmptyMiles: item.allLineEmptyMiles,  //当日计划既有线空驶里程
                    newLinePassenageMiles: item.newLinePassenageMiles,  //当日计划新线载客里程
                    newLineEmptyMiles: item.newLineEmptyMiles,   //当日计划新线空驶里程
