    ...
    render() {
        const columns = [
            ...
            },
            {
                ...
                key: 'scheduleCode',
                render: (text, record) => {
                    return <span onClick={this.openInfo.bind(this, record)} style={{ color: 'rgb(45,182,244)', cursor: 'pointer' }}>{text ? text : ''}</span>
                }
            },
            {
                title: '最大上线列车数',
            ...
            },
            {
                ...
                key: 'startStation',
                render: (text, record) => {
                    return <span className={style.tdSpan}>{text ? text + '~' + record.endStation : ''}</span>
                }
            },
            {
                title: '首末班车时间',
        ...
        const { TimeTableInfoShow, record } = this.state
        return (
