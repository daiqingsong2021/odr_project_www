...
import { getSmsGroupDetailList } from '@/modules/Suzhou/api/suzhou-api';
...
class Energy extends Component {
    ...
    */
    ...
    getList = (currentPageNum, pageSize, callBack) => {
        ...
        const groupId =  this.props.rightData.id
        axios.get(getSmsGroupDetailList(pageSize, currentPageNum), { params: { groupId,searcher} }).then(res => {
